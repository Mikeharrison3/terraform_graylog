...
#Todo
#insert password into /etc/graylog/server/server.conf
#DoNotUseInProdOrCriticalData
...
#TODO Local NIC not public IP
#http_bind_address = 172.20.100.50:9000
#elasticsearch_hosts =http://172.20.101.94:9200
#rest_listen_uri = http://54.162.65.135:9000/api/
#elasticsearch_discovery_zen_ping_multicast_enabled = false
#http_external_uri = publicip:9000
echo "http_bind_address = ${publicIP}:9000" | sudo tee -a /etc/graylog/server/server.conf
